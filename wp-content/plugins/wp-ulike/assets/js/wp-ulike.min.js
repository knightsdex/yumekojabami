!(function (t) {
  (t.fn.WordpressUlikeTooltip = function (e) {
    ...
    let s = i.attr("title");
    void 0 !== s && s.length && (e.title = s),
      (e.class += " ulf-" + e.theme + "-theme"),
      (e.class += " ulf-" + e.size),
      (e.trigger = e.trigger.toLowerCase().trim());
    let n = {
      dom: this,
      dom_wrapped: i,
      ...
      destroy: function () {
        ...
        null != e &&
          (e.dom_wrapped.off("touchstart mouseenter", e.show),
          e.dom_wrapped.off("click", e.preventDefaultHandler),
          t(window).off("resize", e.onResize),
          e.isVisible() && e.hide(),
          e.dom_wrapped.data(e.dataAttr, null));
      },
      initialize: function () {
        return (
          n.dom_wrapped.on("touchstart mouseenter", n.show),
          n.dom_wrapped.on("click", n.preventDefaultHandler),
          t.WordpressUlikeTooltip.body_click_initialized ||
            (t(document).on("touchstart mousedown", n.onClickOutside),
            (t.WordpressUlikeTooltip.bodyClickInitialized = !0)),
      ...
      show: function (e) {
        ...
        (void 0 === e || e) &&
          ...
          (n.content = n.title(n.dom_wrapped, n)),
          i.append(n.createTooltipHTML()),
          (n.tooltip = t(".ulf-tooltip:last")),
          n.positionTooltip(),
          t(window).on("resize", n.onResize);
        ...
        n.observer.observe(document.body, {
          attributes: !0,
          childList: !0,
          subtree: !0,
        });
      ...
      hide: function (e) {
        n.observer && (n.observer.disconnect(), (n.observer = null)),
          ...
          "click" !== n.trigger &&
            n.dom_wrapped.off("touchstart mousedown", n.hide);
      ...
      onClickOutside: function (e) {
        ...
        i.hasClass("ulf-tooltip") ||
          ...
          t.each(t.WordpressUlikeTooltip.visible, function (t, e) {
            void 0 !== e &&
              e.close_on_outside_click &&
              (i !== e.dom_wrapped ||
                ("focus" !== e.trigger && "hoverfocus" !== e.trigger)) &&
              e.hide();
          });
      },
      positionTooltip: function () {
        n.positionDebug("-- Start positioning --"),
          (n.dom_wrapped.length && n.dom_wrapped.is(":visible")) ||
            (n.positionDebug("Elem no longer exists. Removing tooltip"),
            n.hide(!0));
        ...
        return (
          void 0 === l &&
            "auto" !== n.position &&
            (n.positionDebug("Couldn't fit preferred position"),
            ([e, i, s, o, l, a] = n.calculateSafePosition("auto"))),
          void 0 === l
            ? (n.positionDebug("Doesn't appear to fit. Displaying centered"),
              n.tooltip
                .addClass("ulf-centered")
                .css({
                  top: "50%",
                  left: "50%",
                  "margin-left": -s / 2,
              ...
              i < 60 &&
                (n.positionDebug(
                  "Element is less than " +
                    i +
                    "px. Setting arrow to hug the side tighter"
                ),
                (e += " ulf-arrow-super-hug")),
      ...
      calculateSafePosition: function (t) {
        ...
        if (
          ...
          n.positionDebug("Displaying below, centered"),
            (e = "top"),
            (i = l.left - d / 2 + r / 2),
            (s = l.top + a + g / 2);
        else if (
          ...
          if (
            (n.positionDebug("Displaying above, centered"),
            (e = "bottom"),
            n.child_class)
          ) {
          ...
          ("auto" === t || "left" === t) && m.left && m.vertical_half
            ? (n.positionDebug("Displaying left, centered"),
              (e = "right"),
              (i = l.left - d - c / 2),
              (s = l.top + a / 2 - u / 2))
            : ("auto" === t || "right" === t) && m.right && m.vertical_half
            ? (n.positionDebug("Displaying right, centered"),
              (e = "left"),
              (i = l.left + r + c / 2),
              (s = l.top + a / 2 - u / 2))
            : ("auto" === t || "bottom" === t) && m.below && m.right_full
            ? (n.positionDebug("Displaying below, to the right"),
              (e = "top ulf-arrow-hug-left"),
              (i = l.left),
              (s = l.top + a + g / 2))
            : ("auto" === t || "bottom" === t) && m.below && m.left_full
            ? (n.positionDebug("Displaying below, to the left"),
              (e = "top ulf-arrow-hug-right"),
              (i = l.left + r - d),
              (s = l.top + a + g / 2))
            : ("auto" === t || "top" === t) && m.above && m.right_full
            ? (n.positionDebug("Displaying above, to the right"),
              (e = "bottom ulf-arrow-hug-left"),
              (i = l.left),
              (s = l.top - u - g / 2))
            : ("auto" === t || "top" === t) &&
              m.above &&
              m.left_full &&
              (n.positionDebug("Displaying above, to the left"),
              (e = "bottom ulf-arrow-hug-right"),
              (i = l.left + r - d),
              (s = l.top - u - g / 2));
        return [e, r, d, u, i, s];
      },
    ...
    (t.WordpressUlikeTooltip.defaults = {
      id: Date.now(),
      title: "",
      trigger: "hoverfocus",
      position: "auto",
  ...
  (function (t) {
    "use strict";
    var e = "WordpressUlikeNotifications",
      i = {
        messageType: "success",
    ...
    t.extend(s.prototype, {
      ...
      _container: function () {
        t("." + this.settings.notifContainer).length ||
          this.$element.append(
            t("<div/>").addClass(this.settings.notifContainer)
          ),
        ...
        this.$messageElement.on("click", function () {
          t(this)
            .fadeOut(300, function () {
              t(this).remove(),
                t("." + e.settings.messageElement).length ||
                  e.$notifContainer.remove();
            })
      ...
      (this.generalElement = this.$element.find(this.settings.generalSelector)),
        ...
        this.counterElement.length &&
          this.counterElement.each(
            function (e, i) {
              void 0 !== t(i).data("ulike-counter-value") &&
                t(i).html(t(i).data("ulike-counter-value"));
            }.bind(this)
          ),
    ...
    t.extend(a.prototype, {
      ...
      _initLike: function (t) {
        t.stopPropagation(),
          ...
          n.trigger("WordpressUlikeLoading", this.element),
          ...
          this._ajax(
            ...
            function (t) {
              this.generalElement.removeClass("wp_ulike_is_loading"),
                t.success
                  ? (this._updateMarkup(t), this._appendChild())
                  : t.data.hasToast &&
                    this._sendNotification("error", t.data.message),
                this.buttonElement.prop("disabled", !1),
                n.trigger("WordpressUlikeUpdated", this.element);
            }.bind(this)
          );
      },
      ...
      _updateMarkup: function (t) {
        this._setSbilingElement(),
          ...
          null !== t.data.data &&
            (5 != t.data.status &&
              (this.__updateCounter(t.data.data),
              this.settings.displayLikers &&
                void 0 !== t.data.likers &&
                this._updateLikersMarkup(t.data.likers)),
            this._updateButton(t.data.btnText, t.data.status)),
          t.data.hasToast &&
            this._sendNotification(t.data.messageType, t.data.message);
      },
      _updateGeneralClassNames: function (t) {
        ...
        switch (
          (this.siblingElement.length &&
            this.siblingElement.removeClass(this._arrayToString([i, s])),
          t)
        ) {
          case 1:
            this.generalElement.addClass(i).removeClass(e),
              this.generalElement.children().first().addClass(n);
            break;
          case 2:
          ...
          case 0:
          case 5:
            this.generalElement.addClass(n),
              this.siblingElement.length && this.siblingElement.addClass(n);
        }
      },
      ...
      __updateCounter: function (t) {
        this.counterElement.attr("data-ulike-counter-value", t).html(t),
          n.trigger("WordpressUlikeCounterUpdated", [this.buttonElement]);
      },
      _updateLikers: function (t) {
        if (this.settings.displayLikers) {
          if (
            ...
            return;
          if (
            "default" == this.settings.likersTemplate &&
          ...
          return (
            ...
            this._ajax(
              ...
              function (t) {
                this.generalElement.removeClass(
                  "wp_ulike_is_getting_likers_list"
                ),
                  t.success && this._updateLikersMarkup(t.data);
              }.bind(this)
            ),
      ...
      _updateLikersMarkup: function (e) {
        "popover" == this.settings.likersTemplate
          ...
          : (this.likersElement.length ||
              (this.likersElement = t(e.template).appendTo(this.$element)),
            e.template
              ? this.likersElement.show().html(e.template)
              : this.likersElement.hide().empty()),
          n.trigger("WordpressUlikeLikersMarkupUpdated", [
            this.likersElement,
      ...
      _updateSameButtons: function () {
        var t =
          void 0 !== this.settings.factor ? "_" + this.settings.factor : "";
        (this.sameButtons = n.find(
          ".wp_" +
      ...
      _updateSameLikers: function () {
        (this.sameLikers = n.find(
          ".wp_" +
            this.settings.type.toLowerCase() +
            "_likers_" +
            this.settings.ID
        )),
          this.sameLikers.length > 1 && (this.likersElement = this.sameLikers);
      },
        ...
        this.buttonElement.hasClass("wp_ulike_put_image")
          ? (4 == e
              ? this.buttonElement.addClass(
                  "image-unlike wp_ulike_btn_is_active"
                )
            ...
            this.siblingButton.length &&
              this.siblingButton.removeClass(
                "image-unlike wp_ulike_btn_is_active"
              ))
          : this.buttonElement.hasClass("wp_ulike_put_text") &&
            null !== t &&
            this.buttonElement.find("span").html(t);
      },
      _sendNotification: function (e, s) {
        t(i.body).WordpressUlikeNotifications({
          messageType: e,
          messageText: s,
        });
      },
      ...
      new (window.MutationObserver || window.WebKitMutationObserver)(function (
        ...
        s.forEach(function (s) {
          if (s.addedNodes.length)
            for (
              var n = t(s.addedNodes).find(e), o = 0, l = n.length;
              o < l;
              o++
            )
              i(n[o]);
