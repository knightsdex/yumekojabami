      ...
      class MegaMenu extends elementorModules.frontend.handlers.NestedTabs {
        ...
        setContentContainerAbsolutePosition(e) {
          ...
          if (this.shouldPositionContentAbove(e, i)) {
            ...
            e.css({
              position: "absolute",
              bottom: i + +this.getDistanceFromContentSetting(),
              width: n ? "max-content" : "",
              "max-width": t.width,
            });
          }
        ...
        getDistanceFromContentSetting() {
          const e = elementorFrontend.getCurrentDeviceMode(),
            t = "desktop" === e ? "" : "_" + e;
          return this.getElementSettings(
            "menu_item_title_distance_from_content" + t
          ).size;
        }
        onShowTabContent(e) {
        ...
        onMouseTitleEnter(e) {
          ...
          this.isActiveMenuItem(t) ||
            this.changeActiveTab(e.currentTarget.getAttribute("data-tab"), !0);
        }
        isActiveMenuItem(e) {
          return e.some((e) => e.classList.contains("e-active"));
        }
        ...
        isContainingMenuContentTab(e) {
          return e.some((e) => e.classList.contains("e-n-menu-items-content"));
        }
        onMouseLeave(e) {
          e.preventDefault();
          const t = Array.prototype.slice.call(
          ...
          this.isContainingMenuContentTab(t) || this.deactivateActiveTab();
        }
        createMobileTabs() {
          const e = this.getSettings();
          if (elementorFrontend.isEditMode()) {
