/*! bdtUIkit 3.16.24 | https://www.getuikit.com | (c) 2014 - 2023 YOOtheme | MIT License */ (function (
  be,
  $e
) {
  ...
  const Fo = /\B([A-Z])/g,
    ...
    Ct = dt((t) => t.charAt(0).toUpperCase() + t.slice(1));
  function ot(t, e) {
    var i;
  ...
  function k(t) {
    return Xe(t) ? [t] : Array.from(t || []).filter(Xe);
  }
  function ne(t) {
    if (te(t)) return t;
    t = H(t);
  ...
  const Qe = { ratio: Fi, contain: As, cover: Lo };
  ...
  function p(t, e, i) {
    ...
    for (const n of k(t))
      it(i) && (i = i.call(n, p(n, e))),
        i === null ? ke(n, e) : n.setAttribute(e, i);
  }
  function $t(t, e) {
  ...
  function Go(t, e) {
    return (i) => {
      const s =
        t[0] === ">"
          ? Ee(t, i.currentTarget)
              .reverse()
              .filter((n) => B(i.target, n))[0]
          : U(i.target, t);
  ...
  function Ui(t) {
    return Q(t) ? t.map(Ko).filter(Boolean) : D(t) ? Ee(t) : Ms(t) ? [t] : k(t);
  }
  function St(t) {
        ...
        (o) =>
          new Promise((r, a) => {
            ...
            j(
              ...
              y(o, e, Pe + (n ? "leave" : "enter")),
              ot(e, Pe) &&
                (s && y(o, `bdt-transform-origin-${s}`),
                n && y(o, `${Pe}reverse`));
          })
      )
    );
  }
  const er = new RegExp(`${Pe}(enter|leave)`),
    gt = {
      in: zs,
      out(t, e, i, s) {
        return zs(t, e, i, s, !0);
  ...
  function b(t) {
    const e = ee(t)
      ...
      : { height: et(t), width: Ae(t), top: 0, left: 0 };
    return {
      height: e.height,
      width: e.width,
      top: e.top,
  ...
  function _(t, e) {
    ...
    const i = b(t);
    if (t) {
      const { scrollY: s, scrollX: n } = ne(t),
        o = { height: s, width: n };
  ...
  function Ki(t) {
    ...
    if (ee(r)) {
      const a = _(r);
      (e -= a.top + x(c(r, "borderTopWidth"))),
        (i -= a.left + x(c(r, "borderLeftWidth")));
    }
    return { top: e - x(c(t, "marginTop")), left: i - x(c(t, "marginLeft")) };
  }
  function Ht(t) {
    t = H(t);
    ...
    for (; (t = t.offsetParent); )
      if (
        ((e[0] += t.offsetTop + x(c(t, "borderTopWidth"))),
        (e[1] += t.offsetLeft + x(c(t, "borderLeftWidth"))),
        c(t, "position") === "fixed")
      ) {
        const i = ne(t);
  ...
  function ce(t, e, i = "border-box") {
    return c(t, "boxSizing") === i
      ? Dt(
          Ft[e].map(Ct),
          (s) => x(c(t, `padding${s}`)) + x(c(t, `border${s}Width`))
        )
      : 0;
  }
  function ri(t) {
  ...
  function ur() {
    return (
      ...
      (ue ||
        ((ue = w("<div>")),
        c(ue, { height: "100vh", position: "fixed" }),
        $(window, "resize", () => (Oe = null))),
      L(document.body, ue),
      (Oe = ue.clientHeight),
      lt(ue),
      Oe)
  ...
  const Lt = typeof window < "u",
    ...
    fe = Lt && window.PointerEvent,
    mt = fe ? "pointerdown" : Wt ? "touchstart" : "mousedown",
    ai = fe ? "pointermove" : Wt ? "touchmove" : "mousemove",
    Pt = fe ? "pointerup" : Wt ? "touchend" : "mouseup",
    Rt = fe ? "pointerenter" : Wt ? "" : "mouseenter",
    de = fe ? "pointerleave" : Wt ? "" : "mouseleave",
    li = fe ? "pointercancel" : "touchcancel",
    J = {
      reads: [],
      writes: [],
      read(t) {
  ...
  ts.prototype = {
    ...
    init() {
      this.positions = [];
      let t;
      (this.unbind = $(document, "mousemove", (e) => (t = he(e)))),
  ...
  function Vs(t) {
    if ((ui(t) && is(t, { func: "playVideo", method: "play" }), ci(t)))
      try {
        t.play().catch(S);
      } catch {}
  }
  function Ys(t) {
    ui(t) && is(t, { func: "pauseVideo", method: "pause" }), ci(t) && t.pause();
  }
  function Gs(t) {
    ui(t) && is(t, { func: "mute", method: "setVolume", value: 0 }),
      ci(t) && (t.muted = !0);
  }
  function Xs(t) {
    return ci(t) || ui(t);
  ...
  function ls(t, e, i) {
    ...
    !n ||
      (h && !h.call(t)) ||
      t._events.push(
        $(n, s, l ? (D(l) ? l : l.call(t, t)) : null, D(o) ? t[o] : o.bind(t), {
          passive: a,
          capture: r,
          self: u,
        })
  ...
  function Hr(t) {
    return Q(t)
      ? t
      : D(t)
      ? t.split(/,(?![^(]*\))/).map((e) => (bt(e) ? kt(e) : Bi(e.trim())))
      : [t];
  }
  function Lr(t) {
  ...
  function wn(t, e) {
    ...
    return (
      ...
      ft._initialized &&
        !n.functional &&
        requestAnimationFrame(() => Ne(t, `[${s}],[data-${s}]`)),
      (me[s] = n)
    );
  }
  function Ne(t, e, i, ...s) {
  ...
  function xn(t) {
    v(document, "uikit:init", t),
      document.body && It(document.body, yn),
  ...
  async function sa(
    ...
    d && (c(t, N, Jt - Ot + Ps), (No[N] = e ? Ps : Jt + Ps)),
      !d ^ (l === "reveal") &&
        (c(Oi, N, -Jt + Ot), E.start(Oi, { [N]: e ? 0 : -Jt }, s, o));
    try {
  ...
  function gi(t) {
    return He(
      (e, i) => ({
        disconnect: $(e, "scroll", i, { passive: !0, capture: !0 }),
      }),
      { target: () => document, ...t },
      "scroll"
    );
    ...
    events: [
      {
        ...
        async handler(t) {
          ...
          (t.type === "keydown" && t.keyCode !== I.SPACE) ||
            ...
            await this.toggle(ae(this.toggles, t.current)),
            this._off());
        },
      },
      {
  ...
  async function ra(
    ...
    const h = Dt(["marginTop", "marginBottom"], (f) => c(i, f)) + b(i).height,
      u = l / h;
    (s = (n * h + s) * (e ? 1 - u : u)),
      c(a, "height", l),
  ...
  var En = {
      ...
      observe: [ze({ args: { intersecting: !1 } }), pt()],
      update: {
        read({ visible: t }) {
          return Xs(this.$el)
            ? {
  ...
  var _n = {
    ...
    methods: {
      ...
      getPositionOffset(t) {
        return (
          ht(
            this.offset === !1 ? c(t, "--bdt-position-offset") : this.offset,
      ...
      getShiftOffset(t) {
        return this.align === "center"
          ? 0
          : ht(
              c(t, "--bdt-position-shift-offset"),
              this.axis === "y" ? "width" : "height",
              t
            ) * (m(["left", "top"], this.align) ? 1 : -1);
      },
      getViewportOffset(t) {
        return ht(c(t, "--bdt-position-viewport-offset"));
      },
    },
  };
  function ua(t) {
    ...
    events: [
      ...
      },
      {
        ...
        handler() {
          ...
          j(this.$el, "hide", () => t.forEach((e) => e && e()), { self: !0 });
        },
      },
      {
        name: "beforehide",
  ...
  function ga(t) {
    const e = () => t.$emit(),
      i = [es(e), hi(jt(t.$el).concat(t.target), e)];
    return () => i.map((s) => s.disconnect());
  }
  function ma(t) {
    return $([document, ...jt(t.$el)], "scroll", () => t.$emit(), {
      passive: !0,
    });
  }
  function va(t) {
      ...
      },
      {
        ...
        handler(t) {
          ...
          s === I.DOWN &&
            ...
            (t.preventDefault(), (e = w(Ie, n.$el)) == null || e.focus()),
            Bn(t, this.items, n);
        },
      },
      {
          ...
          const e = this.getDropdown(t),
            i = () => {
              ...
              c(this.dropbar, "top", this.dropbar.offsetTop - (r.top - n)),
                this.transitionTo(o - n + x(c(t, "marginBottom")), t);
            };
      ...
      update: {
        read() {
          ...
          if (this.expand)
            ...
            this.offsetBottom === !0
              ? (t += ` - ${b(this.$el.nextElementSibling).height}px`)
              : bt(this.offsetBottom)
              ? (t += ` - ${this.offsetBottom}vh`)
              : this.offsetBottom && Zt(this.offsetBottom, "px")
              ? (t += ` - ${x(this.offsetBottom)}px`)
              : D(this.offsetBottom) &&
                (t += ` - ${b(at(this.offsetBottom, this.$el)).height}px`),
              (t += `${e ? ` - ${e}px` : ""})`);
          }
          return { minHeight: t };
        },
  ...
  function Pa(t, e) {
    ...
    n && !s.some((o) => o) && (s = n.split(" ").slice(2)),
      s.forEach((o, r) => p(t, i[r], x(o) * this.ratio || null));
  }
  var wi = {
      props: { i18n: Object },
      data: { i18n: null },
  ...
  const bi = {
    ...
    Ja = {
      ...
      beforeConnect() {
        ...
        this.icon = U(this.$el, ".bdt-nav-primary") ? `${t}-large` : t;
      },
    },
    Ka = {
      extends: Yt,
      ...
      beforeConnect() {
        if (
          ((this.icon =
            P(this.$el, "bdt-search-icon") &&
            re(this.$el, ".bdt-search-large").length
              ? "search-large"
              : re(this.$el, ".bdt-search-navbar").length
              ? "search-navbar"
              : this.$props.icon),
          !$t(this.$el, "aria-label"))
        )
          if (
            P(this.$el, "bdt-search-toggle") ||
            P(this.$el, "bdt-navbar-toggle")
          ) {
    ...
    Ln = {
      ...
      beforeConnect() {
        ...
        const t = this.$props.icon;
        this.icon = P(this.$el, "bdt-slidenav-large") ? `${t}-large` : t;
      },
    },
    ...
    tl = {
      ...
      beforeConnect() {
        this.icon = `close-${
          P(this.$el, "bdt-close-large") ? "large" : "icon"
        }`;
      },
    },
  ...
  function rl(t) {
    return bi[t]
      ? ($i[t] || ($i[t] = w((bi[al(t)] || bi[t]).trim())), $i[t].cloneNode(!0))
      : null;
  }
  function al(t) {
  ...
  var hl = {
    ...
    connected() {
      ...
      ll && xi(this.$el) && ((this.$el.loading = "lazy"), ms(this.$el)),
        pl(this.$el);
    },
    disconnected() {
    ...
    observe: ze({
      target: ({ $el: t, $props: e }) => [t, ...Te(e.target, t)],
      handler(t, e) {
  ...
  function dl(t) {
    ...
    return Q(t) || (t = [t]), t.filter((e) => !ye(e));
  }
  function pl(t) {
    xi(t) &&
      !$t(t, "src") &&
  ...
  function gl(t, e) {
    if (D(t)) {
      if (ot(t, "@")) t = x(c(e, `--bdt-breakpoint-${t.substr(1)}`));
    ...
    events: [
      {
        ...
        handler(t) {
          const { current: e, defaultPrevented: i } = t,
            { hash: s } = e;
          !i && s && le(e) && !B(s, this.$el) && w(s, document.body)
            ? this.hide()
      ...
      },
      {
        ...
        handler() {
          this.stack &&
            c(this.$el, "zIndex", x(c(this.$el, "zIndex")) + nt.length);
          const t = [
          ...
          j(this.$el, "hidden", () => t.forEach((e) => e && e()), { self: !0 }),
    ...
    return new Promise((n, o) =>
      j(t, "show hide", () => {
        ...
        const a = j(
            ...
            "transitionstart",
            () => {
              j(i, "transitionend transitioncancel", n, { self: !0 }),
                clearTimeout(l);
            },
            { self: !0 }
          ),
    ...
    events: [
      {
        ...
        self: !0,
        handler() {
          P(this.panel, "bdt-margin-auto-vertical")
            ? y(this.$el, "bdt-flex")
      ...
      },
      {
        ...
        self: !0,
        handler() {
          c(this.$el, "display", ""), M(this.$el, "bdt-flex");
        },
      },
    ],
  };
  function yl({ modal: t }) {
    (t.dialog = function (i, s) {
      const n = t(
        `<div class="bdt-modal"> <div class="bdt-modal-dialog">${i}</div> </div>`,
  ...
  var kl = {
    ...
    Sl = {
      ...
      watch: {
        items() {
          const t = P(this.$el, "bdt-navbar-justify");
          for (const e of z(
      ...
      update: {
        read() {
          return R(this.$el) && this.width && this.height
            ? { width: Ae(O(this.$el)), height: this.height }
            : !1;
        },
        write(t) {
          et(
      ...
      observe: ze({
        ...
        handler(t) {
          ...
          for (const { target: i, isIntersecting: s } of t) {
            e.has(i) ||
              e.set(i, { cls: tt(i, "bdt-scrollspy-class") || this.cls });
            const n = e.get(i);
    ...
    Ml = {
      ...
      connected() {
        (this.start = Un(this.start || this.top)),
          ...
          (this.placeholder =
            w("+ .bdt-sticky-placeholder", this.$el) ||
            w('<div class="bdt-sticky-placeholder"></div>')),
          (this.isFixed = !1),
          this.setActive(!1);
      },
      beforeDisconnect() {
      ...
      update: [
        {
          read({ height: t, width: e, margin: i, sticky: s }) {
            if (
              ((this.inactive = !this.matchMedia || !R(this.$el)),
              this.inactive)
            )
              return;
      ...
      methods: {
        ...
        setActive(t) {
          ...
          (this.active = t),
            t
              ? (Yi(this.selTarget, this.clsInactive, this.clsActive),
                e !== t && v(this.$el, "active"))
              : (Yi(this.selTarget, this.clsActive, this.clsInactive),
  ...
  function Ll(t) {
    const e = Gn(t);
    e && c(t, "--bdt-animation-stroke", e);
  }
  const bs = ".bdt-disabled *, .bdt-disabled, [disabled]";
  var Kn = {
      mixins: [Vt],
      args: "connect",
      props: {
      ...
      observe: [
        Fe({ targets: ({ connectChildren: t }) => t }),
        ...
        },
        {
          ...
          el() {
            return this.connects.concat(
              this.itemNav ? Te(this.itemNav, this.$el) : []
            );
          },
          delegate() {
      ...
      methods: {
        ...
        show(t) {
          const e = this.toggles.filter((r) => !C(r, bs)),
            i = this.index(),
            s = rt(!Xe(t) || m(e, t) ? t : 0, e, rt(this.toggles[i], e)),
    ...
    Wl = {
      ...
      connected() {
        const t = P(this.$el, "bdt-tab-left")
          ? "bdt-tab-left"
          : P(this.$el, "bdt-tab-right")
          ? "bdt-tab-right"
          : !1;
        t &&
  ...
  var jl = {
      ...
      computed: {
        target({ target: t }, e) {
          return (t = Te(t || e.hash, e)), (t.length && t) || [e];
        },
      },
      connected() {
        m(this.mode, "media") ||
      ...
      events: [
        {
          ...
          handler(t) {
            (this._preventClick = null),
              !(!St(t) || ie(this._showState) || this.$el.disabled) &&
                (v(this.$el, "focus"),
                j(
                  document,
                  mt,
  ...
  var Vl = {
    ...
    connected() {
      p(this.$el, "role", this.role),
        (this.date = x(Date.parse(this.$props.date))),
        (this.end = !1),
        this.start();
    },
    disconnected() {
  ...
  function ki(t, e) {
    return (
      e && (t.dataset.transition = 1 + ki(t)), kt(t.dataset.transition) || 0
    );
  }
  function Qn(t) {
    return Promise.all(
      ...
      (s || Y(o)) &&
        (n
          ? s
            ...
            : (delete i.filter[n],
              (ye(i.filter) || "" in i.filter) && (i.filter = { "": s || "" }))
          : (i.filter = { "": s || "" })),
      Y(o) || (i.sort = [o, r]),
      i
    );
  ...
  var ao = {
    ...
    scale: {
      show() {
        return [
          { opacity: 0, transform: ve(1 - 0.2) },
          { opacity: 1, transform: ve(1) },
        ];
      },
      percent(t) {
        return 1 - c(t, "opacity");
      ...
      translate(t) {
        return [
          { opacity: 1 - t, transform: ve(1 - 0.2 * t) },
          { opacity: t, transform: ve(1 - 0.2 + 0.2 * t) },
        ];
      },
    },
  };
    ...
    return {
      ...
      show(u, f = 0, d) {
        ...
        return (
          ...
          this.translate(f),
          Si(e, "itemin", { percent: f, duration: u, timing: g, dir: i }),
          Si(t, "itemout", { percent: 1 - f, duration: u, timing: g, dir: i }),
          new Promise((A) => {
            h || (h = A),
              Promise.all([
                E.start(e, l[1], u, g),
  ...
  var fo = {
    ...
    po = {
      ...
      methods: {
        ...
        hideControls() {
          M(this.$el, "bdt-active", "bdt-transition-active");
        },
      },
    };
  function je(t, e) {
  ...
  function Ci(t, e, i) {
    ...
    return (
      t === "x" || t === "y"
        ? ((t = `translate${Ct(t)}`),
          (n = (o) => x(x(o).toFixed(s === "px" ? 0 : 6))))
        : t === "scale" &&
          ((s = ""),
          (n = (o) => (Ei([o]) ? ht(o, "width", e, !0) / e.offsetWidth : o))),
      ...
      (s, n) => {
        const [o, r, a] = xo(i, n),
          l = o
            .map(
              (h, u) => (
                (h += a * (r[u] - h)), u === 3 ? x(h) : parseInt(h, 10)
              )
            )
            .join(",");
        s[t] = `rgba(${l})`;
  ...
  function bh(t, e, i) {
    ...
    const s = Ei(i),
      n = Gn(e);
    return (
      (i = we(i.reverse(), (o) => ((o = x(o)), s === "%" ? (o * n) / 100 : o))),
      i.some(([o]) => o)
  ...
  function Ih(t, e, i, { center: s, easing: n, list: o }) {
    const r = t ? Ve(t, o, s) : Ve(e, o, s) + b(e).width * i,
      a = e ? Ve(e, o, s) : r + b(t).width * i * (X ? -1 : 1);
    let l;
    return {
      dir: i,
      show(h, u = 0, f) {
      ...
      translate(h) {
        ...
        c(
          o,
          "transform",
          W(Z(-a + (u - u * h), -Pi(o), b(o).width) * (X ? -1 : 1), "px")
        );
  ...
  function _i(t, e) {
    return (
      (t && (Ki(t).left + (X ? b(t).width - b(e).width : 0)) * (X ? -1 : 1)) ||
      0
    );
  }
  function To(t, e) {
    ...
    methods: {
      ...
      updateActiveClasses() {
        const t = this._getTransitioner(this.index).getActives(),
          e = [
            this.clsActive,
            ((!this.sets || m(this.sets, x(this.index))) &&
              this.clsActivated) ||
              "",
          ];
  ...
  var _h = {
      ...
      scale: {
        show() {
          return [
            { opacity: 0, transform: ve(1 + 0.5), zIndex: 0 },
            { zIndex: -1 },
          ];
        },
        percent(t) {
        ...
        translate(t) {
          return [
            { opacity: 1 - t, transform: ve(1 + 0.5 * t), zIndex: 0 },
            { zIndex: -1 },
          ];
        },
      },
      ...
      methods: {
        init(t) {
          ...
          !n ||
            ...
            Li(e) ||
            B(e, `.${this.clsNoDrag}`) ||
            (this.handle && !B(e, this.handle)) ||
            (t.preventDefault(),
            (this.touched = new Set([this])),
            (this.placeholder = n),
            (this.origin = { target: e, index: ae(n), ...this.pos }),
            $(document, ai, this.move),
            $(document, Pt, this.end),
        ...
        move(t) {
          ...
          if (
            (Bt(document, ai, this.move),
            Bt(document, Pt, this.end),
            !this.drag)
          )
            return;
          Bh();
          ...
          this === t
            ? this.origin.index !== ae(this.placeholder) &&
  ...
  function Dh(t) {
    ...
    Ao = setInterval(() => {
      ...
      (e = Date.now()),
        pe(document.elementFromPoint(i, t.y))
          .reverse()
          .some((o) => {
          ...
          $(this.tooltip, "toggled", (t, e) => {
            ...
            const o = [
              j(
                ...
                !1,
                (r) =>
                  (r.type === mt && !B(r.target, this.$el)) ||
                  (r.type === "keydown" && r.keyCode === I.ESC)
              ),
              $([document, ...jt(this.$el)], "scroll", i, { passive: !0 }),
            ];
            j(this.tooltip, "hide", () => o.forEach((r) => r()), { self: !0 });
          }),
  ...
  function Uh(t, e) {
    return new Promise((i, s) => {
      ...
      $(n, "load", () => {
        ...
        $(n, "error", () => s(wt(Error("Network Error"), { xhr: n }))),
        $(n, "timeout", () => s(wt(Error("Network Timeout"), { xhr: n }))),
        n.send(e.data);
    });
  }
