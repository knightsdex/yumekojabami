(function ($, window, document, undefined) {
  var AuxinRemoveCartContent = function () {
    ...
    $(document).on("click", ".aux-remove-cart-content", function (e) {
      ...
      var $cartBoxEl = $(this)
        .closest(".aux-cart-wrapper")
        .addClass("aux-cart-remove-in-progress");
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          $("#offcart .aux-cart-wrapper .aux-card-dropdown").removeClass(
            "aux-phone-off"
          );
        },
      });
  ...
  var AuxinAjaxAddToCart = function () {
    ...
    $(document).on("click", ".aux-ajax-add-to-cart", function (e) {
      ...
      var hasAnimation = $cartBoxEl.hasClass("aux-basket-animation")
        ? true
        : false;
      ...
      if ($(this).parents(".aux-shop-quicklook-modal")) {
        quantity = $(this)
          .parents(".aux-shop-quicklook-modal")
          .find(".quantity input")
          .val();
      }
  ...
  var AjaxRecentProductsPagination = function () {
    $("a.page-numbers").on("click", function (e) {
      ...
      e.preventDefault();
      var $widgetWrapper = $(this).parents(".elementor-widget-container").length
          ? $(this).parents(".elementor-widget-container")
          : $(this).parents(".elementor-widget"),
        widgetData = $widgetWrapper
          .find(".aux-recent-products-wrapper")
          .data("widget-data"),
        paged = $(this).data("paged");

      $widgetWrapper.find(".aux-widget-recent-products").addClass("loading");
      $widgetWrapper
        .find(".aux-isotope-animated .aux-items-loading")
