...
!(function (e, t) {
    ...
    a = function (e, t) {
      ...
      for (o = 0; o < e.length; o++)
        e[o] instanceof google.maps.LatLng ||
          (0 < e[o].length && "object" == typeof e[o][0]
            ? (e[o] = a(e[o], t))
            : (e[o] =
                ((n = e[o]),
                (r = t),
    ...
    p =
      ...
      (z = function (o) {
        ...
        var e,
          ...
          y = t(o.scaleControl, !0),
          v = t(o.streetViewControl, !0),
          w = t(w, !0),
          k = {},
        ...
        for (
          ...
          delete o[i[e]];
        for (
          1 != o.disableDefaultUI && (L = S(L, b)), k = S(L, o), e = 0;
          e < n.length;
          e++
        )
          delete k[n[e]];
        for (e = 0; e < r.length; e++) delete k[r[e]];
        (this.map = new google.maps.Map(this.el, k)),
          a && (this.markerClusterer = a.apply(this, [this.map]));
        var _ = function (t, o) {
          var e = "",
            n = window.context_menu[u.el.id][t];
          for (var r in n)
            ...
            for (r = 0; r < l; r++) {
              ...
              google.maps.event.clearListeners(p, "click"),
                google.maps.event.addDomListenerOnce(
                  ...
                  function (e) {
                    e.preventDefault(),
                      n[this.id.replace(t + "_", "")].action.apply(u, [o]),
                      u.hideContextMenu();
                  },
                  !1
                );
        ...
        (this.buildContextMenu = function (o, n) {
          ...
          (this.setContextMenu = function (e) {
            ...
            (o.id = "gmaps_context_menu"),
              (o.style.display = "none"),
              (o.style.position = "absolute"),
              (o.style.minWidth = "100px"),
              (o.style.background = "white"),
              (o.style.listStyle = "none"),
              (o.style.padding = "8px"),
              (o.style.boxShadow = "2px 2px 6px #ccc"),
              W("gmaps_context_menu") || T.body.appendChild(o);
        ...
        google.maps.event.addListener(this.map, "rightclick", function (e) {
          o.rightclick && o.rightclick.apply(this, [e]),
            null != window.context_menu[u.el.id].map &&
              u.buildContextMenu("map", e);
        }),
        ...
        var O,
          P = [];
        for (O in this.map)
          "function" != typeof this.map[O] || this[O] || P.push(O);
  ...
  return (
    (p.prototype.createControl = function (o) {
      var e = document.createElement("div");
      for (var t in ((e.style.cursor = "pointer"),
      !0 !== o.disableDefaultStyles &&
        ((e.style.fontFamily = "Roboto, Arial, sans-serif"),
        (e.style.fontSize = "11px"),
        (e.style.boxShadow = "rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px")),
      o.style))
        e.style[t] = o.style[t];
      for (var n in (o.id && (e.id = o.id),
      o.title && (e.title = o.title),
      o.classes && (e.className = o.classes),
      o.content &&
        ("string" == typeof o.content
          ? (e.innerHTML = o.content)
          : o.content instanceof HTMLElement && e.appendChild(o.content)),
      o.position &&
        (e.position = google.maps.ControlPosition[o.position.toUpperCase()]),
      o.events))
        !(function (e, t) {
    ...
    (p.prototype.createMarker = function (n) {
      ...
      var t = this,
        ...
        o = n.fences,
        r = n.outside,
        i = { position: new google.maps.LatLng(n.lat, n.lng), map: null },
        s = S(i, n);
      ...
      for (p = 0; p < c.length; p++)
        !(function (e, t) {
          n[t] &&
            google.maps.event.addListener(e, t, function () {
              n[t].apply(this, [this]);
            });
        })(a, c[p]);
      ...
      return (
        google.maps.event.addListener(a, "click", function () {
          (this.details = e),
            ...
            a.infoWindow && (t.hideInfoWindows(), a.infoWindow.open(t.map, a));
        }),
    ...
    (p.prototype.drawOverlay = function (s) {
      ...
      return (
        a.setMap(this.map),
        null != s.auto_show && (i = s.auto_show),
        (a.onAdd = function () {
          var e = document.createElement("div");
          ...
          s.click &&
            (n.overlayMouseTarget.appendChild(a.el),
        ...
        (a.draw = function () {
          ...
          (s.horizontalOffset = s.horizontalOffset || 0),
            (s.verticalOffset = s.verticalOffset || 0);
          var t = a.el,
            o = t.children[0],
            n = o.clientHeight,
            r = o.clientWidth;
          ...
          (t.style.display = i ? "block" : "none"),
            i || s.show.apply(this, [t]);
        }),
        (a.onRemove = function () {
          var e = a.el;
          s.remove
            ? s.remove.apply(this, [e])
    ...
    (p.prototype.drawPolyline = function (o) {
      ...
      o.hasOwnProperty("clickable") && (i.clickable = o.clickable),
        o.hasOwnProperty("editable") && (i.editable = o.editable),
        o.hasOwnProperty("icons") && (i.icons = o.icons),
        o.hasOwnProperty("zIndex") && (i.zIndex = o.zIndex);
      for (
    ...
    (p.prototype.drawRectangle = function (o) {
      ...
      o.bounds = e;
      for (
        var t = new google.maps.Rectangle(o),
          n = [
            "click",
            "dblclick",
            "mousedown",
    ...
    (p.prototype.drawPolygon = function (o) {
      ...
      o.hasOwnProperty("useGeoJSON") && (e = o.useGeoJSON),
        ...
        0 < o.paths.length &&
          0 < o.paths[0].length &&
          (o.paths = s(i(o.paths, a, e)));
      for (
        var t = new google.maps.Polygon(o),
          n = [
            "click",
            "dblclick",
            "mousedown",
    ...
    (p.prototype.getFromFusionTables = function (e) {
      ...
      delete e.events;
      var t = e,
        n = new google.maps.FusionTablesLayer(t);
      for (var r in o)
        !(function (e, t) {
          google.maps.event.addListener(e, t, function (e) {
            o[t].apply(this, [e]);
      ...
      new google.maps.DirectionsService().route(e, function (e, t) {
        if (t === google.maps.DirectionsStatus.OK) {
          for (var o in e.routes)
            e.routes.hasOwnProperty(o) && r.push(e.routes[o]);
    ...
    (p.prototype.getElevations = function (e) {
      0 <
        (e = S({ locations: [], path: !1, samples: 256 }, e)).locations
          .length &&
        0 < e.locations[0].length &&
        (e.locations = s(i([e.locations], a, !1)));
      var o = e.callback;
      delete e.callback;
      ...
      if (e.path) {
        ...
        delete e.path,
          delete e.samples,
          t.getElevationForLocations(e, function (e, t) {
            o && "function" == typeof o && o(e, t);
          });
    }),
    ...
    (p.prototype.travelRoute = function (i) {
      if (i.origin && i.destination)
        this.getRoutes({
          ...
          callback: function (e) {
            if (
              (0 < e.length && i.start && i.start(e[e.length - 1]),
              0 < e.length && i.step)
            ) {
              var t = e[e.length - 1];
              if (0 < t.legs.length)
                for (var o, n = t.legs[0].steps, r = 0; (o = n[r]); r++)
                  (o.step_number = r), i.step(o, t.legs[0].steps.length - 1);
            }
            0 < e.length && i.end && i.end(e[e.length - 1]);
          },
        });
      else if (i.route && 0 < i.route.legs.length)
        for (var e, t = i.route.legs[0].steps, o = 0; (e = t[o]); o++)
          (e.step_number = o), i.step(e);
    }),
            ...
            if (
              ...
              if (0 < t.legs.length)
                for (var o, n = t.legs[0].steps, r = 0; (o = n[r]); r++) {
                  ...
                  s.hasOwnProperty("icons") && (i.icons = s.icons),
                    a.drawPolyline(i),
    ...
    (p.staticMapURL = function (e) {
      ...
      for (var g in (delete e.sensor, n.push("sensor=" + c), e))
        e.hasOwnProperty(g) && n.push(g + "=" + e[g]);
      if (i)
    ...
    (p.fire = function (e, t, o) {
      if (-1 == p.custom_events.indexOf(e))
        ...
        for (var n = o.registered_events[e], r = 0; r < n.length; r++)
          (i = n[r].handler), (s = o), (a = t), i.apply(s, [a]);
      var i, s, a;
    }),
    ...
    Array.prototype.indexOf ||
      (Array.prototype.indexOf = function (e) {
        ...
        if (
          ...
          return -1;
        for (var r = 0 <= n ? n : Math.max(o - Math.abs(n), 0); r < o; r++)
